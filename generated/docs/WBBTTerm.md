...
```mermaid
 classDiagram
      AnatomicalTerm <|-- WBBTTerm
      
      WBBTTerm : ancestors
      WBBTTerm : created_by
      WBBTTerm : cross_references
      WBBTTerm : curie
      WBBTTerm : date_created
      WBBTTerm : date_updated
      WBBTTerm : db_date_created
      WBBTTerm : db_date_updated
      WBBTTerm : dbkey
      WBBTTerm : definition
      WBBTTerm : definition_urls
      WBBTTerm : descendants
      WBBTTerm : internal
      WBBTTerm : name
      WBBTTerm : namespace
      WBBTTerm : obsolete
      WBBTTerm : secondary_identifiers
      WBBTTerm : subsets
      WBBTTerm : synonyms
      WBBTTerm : type
      WBBTTerm : updated_by
...
URI: [alliance:WBBTTerm](http://alliancegenome.org/WBBTTerm)
...
| ---  | ---  |
| self | ['alliance:WBBTTerm'] |
| native | ['alliance:WBBTTerm'] |
