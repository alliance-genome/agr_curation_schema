...
```mermaid
 classDiagram
      AnatomicalTerm <|-- ZFATerm
      
      ZFATerm : ancestors
      ZFATerm : created_by
      ZFATerm : cross_references
      ZFATerm : curie
      ZFATerm : date_created
      ZFATerm : date_updated
      ZFATerm : db_date_created
      ZFATerm : db_date_updated
      ZFATerm : dbkey
      ZFATerm : definition
      ZFATerm : definition_urls
      ZFATerm : descendants
      ZFATerm : internal
      ZFATerm : name
      ZFATerm : namespace
      ZFATerm : obsolete
      ZFATerm : secondary_identifiers
      ZFATerm : subsets
      ZFATerm : synonyms
      ZFATerm : type
      ZFATerm : updated_by
...
URI: [alliance:ZFATerm](http://alliancegenome.org/ZFATerm)
...
| ---  | ---  |
| self | ['alliance:ZFATerm'] |
| native | ['alliance:ZFATerm'] |
