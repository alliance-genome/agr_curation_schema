...
```mermaid
 classDiagram
      ...
      MITerm : ancestors
      MITerm : created_by
      MITerm : cross_references
      MITerm : curie
      MITerm : date_created
      MITerm : date_updated
      MITerm : db_date_created
      MITerm : db_date_updated
      MITerm : dbkey
      MITerm : definition
      MITerm : definition_urls
      MITerm : descendants
      MITerm : internal
      MITerm : name
      MITerm : namespace
      MITerm : obsolete
      MITerm : secondary_identifiers
      MITerm : subsets
      MITerm : synonyms
      MITerm : type
      MITerm : updated_by
...
URI: [alliance:MITerm](http://alliancegenome.org/MITerm)
...
| ---  | ---  |
| self | ['alliance:MITerm'] |
| native | ['alliance:MITerm'] |
