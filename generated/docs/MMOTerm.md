...
```mermaid
 classDiagram
      OntologyTerm <|-- MMOTerm
      
      MMOTerm : ancestors
      MMOTerm : created_by
      MMOTerm : cross_references
      MMOTerm : curie
      MMOTerm : date_created
      MMOTerm : date_updated
      MMOTerm : db_date_created
      MMOTerm : db_date_updated
      MMOTerm : dbkey
      MMOTerm : definition
      MMOTerm : definition_urls
      MMOTerm : descendants
      MMOTerm : internal
      MMOTerm : name
      MMOTerm : namespace
      MMOTerm : obsolete
      MMOTerm : secondary_identifiers
      MMOTerm : subsets
      MMOTerm : synonyms
      MMOTerm : type
      MMOTerm : updated_by
...
URI: [alliance:MMOTerm](http://alliancegenome.org/MMOTerm)
...
| ---  | ---  |
| self | ['alliance:MMOTerm'] |
| native | ['alliance:MMOTerm'] |
