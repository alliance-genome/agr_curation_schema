...
```mermaid
 classDiagram
      AnatomicalTerm <|-- XBATerm
      
      XBATerm : ancestors
      XBATerm : created_by
      XBATerm : cross_references
      XBATerm : curie
      XBATerm : date_created
      XBATerm : date_updated
      XBATerm : db_date_created
      XBATerm : db_date_updated
      XBATerm : dbkey
      XBATerm : definition
      XBATerm : definition_urls
      XBATerm : descendants
      XBATerm : internal
      XBATerm : name
      XBATerm : namespace
      XBATerm : obsolete
      XBATerm : secondary_identifiers
      XBATerm : subsets
      XBATerm : synonyms
      XBATerm : type
      XBATerm : updated_by
...
URI: [alliance:XBATerm](http://alliancegenome.org/XBATerm)
...
| ---  | ---  |
| self | ['alliance:XBATerm'] |
| native | ['alliance:XBATerm'] |
