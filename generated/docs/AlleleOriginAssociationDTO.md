...
```mermaid
 classDiagram
      ...
      AlleleOriginAssociationDTO : agm_curie
      AlleleOriginAssociationDTO : allele_curie
      AlleleOriginAssociationDTO : created_by_curie
      AlleleOriginAssociationDTO : date_created
      AlleleOriginAssociationDTO : date_updated
      AlleleOriginAssociationDTO : db_date_created
      AlleleOriginAssociationDTO : db_date_updated
      AlleleOriginAssociationDTO : evidence_curies
      AlleleOriginAssociationDTO : internal
      AlleleOriginAssociationDTO : obsolete
      AlleleOriginAssociationDTO : predicate_name
      AlleleOriginAssociationDTO : updated_by_curie
...
URI: [alliance:AlleleOriginAssociationDTO](http://alliancegenome.org/AlleleOriginAssociationDTO)
...
| ---  | ---  |
| self | ['alliance:AlleleOriginAssociationDTO'] |
| native | ['alliance:AlleleOriginAssociationDTO'] |
...
<details>
```yaml
name: AlleleOriginAssociationDTO
description: The relationship between an allele and the AGM origin of the allele.
...
attributes:
  allele_curie:
    ...
    from_schema: https://github.com/alliance-genome/agr_curation_schema/src/schema/alleleDTO
    alias: allele_curie
    owner: AlleleOriginAssociationDTO
    domain_of:
