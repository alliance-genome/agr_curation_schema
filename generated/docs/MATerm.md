...
```mermaid
 classDiagram
      AnatomicalTerm <|-- MATerm
      
      MATerm : ancestors
      MATerm : created_by
      MATerm : cross_references
      MATerm : curie
      MATerm : date_created
      MATerm : date_updated
      MATerm : db_date_created
      MATerm : db_date_updated
      MATerm : dbkey
      MATerm : definition
      MATerm : definition_urls
      MATerm : descendants
      MATerm : internal
      MATerm : name
      MATerm : namespace
      MATerm : obsolete
      MATerm : secondary_identifiers
      MATerm : subsets
      MATerm : synonyms
      MATerm : type
      MATerm : updated_by
...
URI: [alliance:MATerm](http://alliancegenome.org/MATerm)
...
| ---  | ---  |
| self | ['alliance:MATerm'] |
| native | ['alliance:MATerm'] |
