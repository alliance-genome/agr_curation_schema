...
```mermaid
 classDiagram
      AnatomicalTerm <|-- DAOTerm
      
      DAOTerm : ancestors
      DAOTerm : created_by
      DAOTerm : cross_references
      DAOTerm : curie
      DAOTerm : date_created
      DAOTerm : date_updated
      DAOTerm : db_date_created
      DAOTerm : db_date_updated
      DAOTerm : dbkey
      DAOTerm : definition
      DAOTerm : definition_urls
      DAOTerm : descendants
      DAOTerm : internal
      DAOTerm : name
      DAOTerm : namespace
      DAOTerm : obsolete
      DAOTerm : secondary_identifiers
      DAOTerm : subsets
      DAOTerm : synonyms
      DAOTerm : type
      DAOTerm : updated_by
...
URI: [alliance:DAOTerm](http://alliancegenome.org/DAOTerm)
...
| ---  | ---  |
| self | ['alliance:DAOTerm'] |
| native | ['alliance:DAOTerm'] |
