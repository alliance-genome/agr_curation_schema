...
```mermaid
 classDiagram
      ...
      DOTerm : ancestors
      DOTerm : created_by
      DOTerm : cross_references
      DOTerm : curie
      DOTerm : date_created
      DOTerm : date_updated
      DOTerm : db_date_created
      DOTerm : db_date_updated
      DOTerm : dbkey
      DOTerm : definition
      DOTerm : definition_urls
      DOTerm : descendants
      DOTerm : internal
      DOTerm : name
      DOTerm : namespace
      DOTerm : obsolete
      DOTerm : secondary_identifiers
      DOTerm : subsets
      DOTerm : synonyms
      DOTerm : type
      DOTerm : updated_by
...
URI: [alliance:DOTerm](http://alliancegenome.org/DOTerm)
...
| ---  | ---  |
| self | ['alliance:DOTerm'] |
| native | ['alliance:DOTerm'] |
