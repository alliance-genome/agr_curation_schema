...
```mermaid
 classDiagram
      OntologyTerm <|-- FBCVTerm
      
      FBCVTerm : ancestors
      FBCVTerm : created_by
      FBCVTerm : cross_references
      FBCVTerm : curie
      FBCVTerm : date_created
      FBCVTerm : date_updated
      FBCVTerm : db_date_created
      FBCVTerm : db_date_updated
      FBCVTerm : dbkey
      FBCVTerm : definition
      FBCVTerm : definition_urls
      FBCVTerm : descendants
      FBCVTerm : internal
      FBCVTerm : name
      FBCVTerm : namespace
      FBCVTerm : obsolete
      FBCVTerm : secondary_identifiers
      FBCVTerm : subsets
      FBCVTerm : synonyms
      FBCVTerm : type
      FBCVTerm : updated_by
...
URI: [alliance:FBCVTerm](http://alliancegenome.org/FBCVTerm)
...
| ---  | ---  |
| self | ['alliance:FBCVTerm'] |
| native | ['alliance:FBCVTerm'] |
