...
```mermaid
 classDiagram
      ...
      WBLSTerm : ancestors
      WBLSTerm : created_by
      WBLSTerm : cross_references
      WBLSTerm : curie
      WBLSTerm : date_created
      WBLSTerm : date_updated
      WBLSTerm : db_date_created
      WBLSTerm : db_date_updated
      WBLSTerm : dbkey
      WBLSTerm : definition
      WBLSTerm : definition_urls
      WBLSTerm : descendants
      WBLSTerm : internal
      WBLSTerm : name
      WBLSTerm : namespace
      WBLSTerm : obsolete
      WBLSTerm : secondary_identifiers
      WBLSTerm : subsets
      WBLSTerm : synonyms
      WBLSTerm : type
      WBLSTerm : updated_by
...
URI: [alliance:WBLSTerm](http://alliancegenome.org/WBLSTerm)
...
| ---  | ---  |
| self | ['alliance:WBLSTerm'] |
| native | ['alliance:WBLSTerm'] |
