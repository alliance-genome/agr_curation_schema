...
```mermaid
 classDiagram
      ChemicalTerm <|-- XSMOTerm
      
      XSMOTerm : ancestors
      XSMOTerm : created_by
      XSMOTerm : cross_references
      XSMOTerm : curie
      XSMOTerm : date_created
      XSMOTerm : date_updated
      XSMOTerm : db_date_created
      XSMOTerm : db_date_updated
      XSMOTerm : dbkey
      XSMOTerm : definition
      XSMOTerm : definition_urls
      XSMOTerm : descendants
      XSMOTerm : formula
      XSMOTerm : inchi
      XSMOTerm : inchi_key
      XSMOTerm : internal
      ...
      XSMOTerm : namespace
      XSMOTerm : obsolete
      XSMOTerm : secondary_identifiers
      XSMOTerm : smiles
      XSMOTerm : subsets
      XSMOTerm : synonyms
      XSMOTerm : type
...
URI: [alliance:XSMOTerm](http://alliancegenome.org/XSMOTerm)
...
| ---  | ---  |
| self | ['alliance:XSMOTerm'] |
| native | ['alliance:XSMOTerm'] |
