...
```mermaid
 classDiagram
      PhenotypeTerm <|-- MPTerm
      
      MPTerm : ancestors
      MPTerm : created_by
      MPTerm : cross_references
      MPTerm : curie
      MPTerm : date_created
      MPTerm : date_updated
      MPTerm : db_date_created
      MPTerm : db_date_updated
      MPTerm : dbkey
      MPTerm : definition
      MPTerm : definition_urls
      MPTerm : descendants
      MPTerm : internal
      MPTerm : name
      MPTerm : namespace
      MPTerm : obsolete
      MPTerm : secondary_identifiers
      MPTerm : subsets
      MPTerm : synonyms
      MPTerm : type
      MPTerm : updated_by
...
URI: [alliance:MPTerm](http://alliancegenome.org/MPTerm)
...
| ---  | ---  |
| self | ['alliance:MPTerm'] |
| native | ['alliance:MPTerm'] |
