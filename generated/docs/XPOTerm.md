...
```mermaid
 classDiagram
      PhenotypeTerm <|-- XPOTerm
      
      XPOTerm : ancestors
      XPOTerm : created_by
      XPOTerm : cross_references
      XPOTerm : curie
      XPOTerm : date_created
      XPOTerm : date_updated
      XPOTerm : db_date_created
      XPOTerm : db_date_updated
      XPOTerm : dbkey
      XPOTerm : definition
      XPOTerm : definition_urls
      XPOTerm : descendants
      XPOTerm : internal
      XPOTerm : name
      XPOTerm : namespace
      XPOTerm : obsolete
      XPOTerm : secondary_identifiers
      XPOTerm : subsets
      XPOTerm : synonyms
      XPOTerm : type
      XPOTerm : updated_by
...
URI: [alliance:XPOTerm](http://alliancegenome.org/XPOTerm)
...
| ---  | ---  |
| self | ['alliance:XPOTerm'] |
| native | ['alliance:XPOTerm'] |
