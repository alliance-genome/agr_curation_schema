...
```mermaid
 classDiagram
      ...
      FBDVTerm : ancestors
      FBDVTerm : created_by
      FBDVTerm : cross_references
      FBDVTerm : curie
      FBDVTerm : date_created
      FBDVTerm : date_updated
      FBDVTerm : db_date_created
      FBDVTerm : db_date_updated
      FBDVTerm : dbkey
      FBDVTerm : definition
      FBDVTerm : definition_urls
      FBDVTerm : descendants
      FBDVTerm : internal
      FBDVTerm : name
      FBDVTerm : namespace
      FBDVTerm : obsolete
      FBDVTerm : secondary_identifiers
      FBDVTerm : subsets
      FBDVTerm : synonyms
      FBDVTerm : type
      FBDVTerm : updated_by
...
URI: [alliance:FBDVTerm](http://alliancegenome.org/FBDVTerm)
...
| ---  | ---  |
| self | ['alliance:FBDVTerm'] |
| native | ['alliance:FBDVTerm'] |
