...
```mermaid
 classDiagram
      ChemicalTerm <|-- CHEBITerm
      
      CHEBITerm : ancestors
      CHEBITerm : created_by
      CHEBITerm : cross_references
      CHEBITerm : curie
      CHEBITerm : date_created
      CHEBITerm : date_updated
      CHEBITerm : db_date_created
      CHEBITerm : db_date_updated
      CHEBITerm : dbkey
      CHEBITerm : definition
      CHEBITerm : definition_urls
      CHEBITerm : descendants
      CHEBITerm : formula
      CHEBITerm : inchi
      CHEBITerm : inchi_key
      CHEBITerm : internal
      ...
      CHEBITerm : namespace
      CHEBITerm : obsolete
      CHEBITerm : secondary_identifiers
      CHEBITerm : smiles
      CHEBITerm : subsets
      CHEBITerm : synonyms
      CHEBITerm : type
      CHEBITerm : updated_by
...
URI: [alliance:CHEBITerm](http://alliancegenome.org/CHEBITerm)
...
| ---  | ---  |
| self | ['alliance:CHEBITerm'] |
| native | ['alliance:CHEBITerm'] |
