...
```mermaid
 classDiagram
      OntologyTerm <|-- ECOTerm
      
      ECOTerm : abbreviation
      ECOTerm : ancestors
      ECOTerm : created_by
      ECOTerm : cross_references
      ECOTerm : curie
      ECOTerm : date_created
      ECOTerm : date_updated
      ECOTerm : db_date_created
      ECOTerm : db_date_updated
      ECOTerm : dbkey
      ECOTerm : definition
      ECOTerm : definition_urls
      ECOTerm : descendants
      ECOTerm : internal
      ECOTerm : name
      ECOTerm : namespace
      ECOTerm : obsolete
      ECOTerm : secondary_identifiers
      ECOTerm : subsets
      ECOTerm : synonyms
      ECOTerm : type
      ECOTerm : updated_by
...
URI: [alliance:ECOTerm](http://alliancegenome.org/ECOTerm)
...
| Name | Description  |
| ---  | ---  |
| [abbreviation](abbreviation.md) | Letter code used by curators to refer to the ECO term. |
...
| ---  | ---  |
| self | ['alliance:ECOTerm'] |
| native | ['alliance:ECOTerm'] |
