...
```mermaid
 classDiagram
      AnatomicalTerm <|-- CLTerm
      
      CLTerm : ancestors
      CLTerm : created_by
      CLTerm : cross_references
      CLTerm : curie
      CLTerm : date_created
      CLTerm : date_updated
      CLTerm : db_date_created
      CLTerm : db_date_updated
      CLTerm : dbkey
      CLTerm : definition
      CLTerm : definition_urls
      CLTerm : descendants
      CLTerm : internal
      CLTerm : name
      CLTerm : namespace
      CLTerm : obsolete
      CLTerm : secondary_identifiers
      CLTerm : subsets
      CLTerm : synonyms
      CLTerm : type
      CLTerm : updated_by
...
URI: [alliance:CLTerm](http://alliancegenome.org/CLTerm)
...
| ---  | ---  |
| self | ['alliance:CLTerm'] |
| native | ['alliance:CLTerm'] |
