...
```mermaid
 classDiagram
      GenomicEntity <|-- ConstructComponent
      
      ConstructComponent : created_by
      ConstructComponent : cross_references
      ConstructComponent : curie
      ConstructComponent : date_created
      ConstructComponent : date_updated
      ConstructComponent : db_date_created
      ConstructComponent : db_date_updated
      ConstructComponent : genomic_location_associations
      ConstructComponent : internal
      ConstructComponent : obsolete
      ConstructComponent : secondary_identifiers
      ConstructComponent : taxon
      ConstructComponent : updated_by
...
URI: [alliance:ConstructComponent](http://alliancegenome.org/ConstructComponent)
...
| ---  | ---  |
| self | ['alliance:ConstructComponent'] |
| native | ['alliance:ConstructComponent'] |
