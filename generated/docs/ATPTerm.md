...
```mermaid
 classDiagram
      OntologyTerm <|-- ATPTerm
      
      ATPTerm : ancestors
      ATPTerm : created_by
      ATPTerm : cross_references
      ATPTerm : curie
      ATPTerm : date_created
      ATPTerm : date_updated
      ATPTerm : db_date_created
      ATPTerm : db_date_updated
      ATPTerm : dbkey
      ATPTerm : definition
      ATPTerm : definition_urls
      ATPTerm : descendants
      ATPTerm : internal
      ATPTerm : name
      ATPTerm : namespace
      ATPTerm : obsolete
      ATPTerm : secondary_identifiers
      ATPTerm : subsets
      ATPTerm : synonyms
      ATPTerm : type
      ATPTerm : updated_by
...
URI: [alliance:ATPTerm](http://alliancegenome.org/ATPTerm)
...
| ---  | ---  |
| self | ['alliance:ATPTerm'] |
| native | ['alliance:ATPTerm'] |
