...
```mermaid
 classDiagram
      ...
      ZFSTerm : ancestors
      ZFSTerm : created_by
      ZFSTerm : cross_references
      ZFSTerm : curie
      ZFSTerm : date_created
      ZFSTerm : date_updated
      ZFSTerm : db_date_created
      ZFSTerm : db_date_updated
      ZFSTerm : dbkey
      ZFSTerm : definition
      ZFSTerm : definition_urls
      ZFSTerm : descendants
      ZFSTerm : internal
      ZFSTerm : name
      ZFSTerm : namespace
      ZFSTerm : obsolete
      ZFSTerm : secondary_identifiers
      ZFSTerm : subsets
      ZFSTerm : synonyms
      ZFSTerm : type
      ZFSTerm : updated_by
...
URI: [alliance:ZFSTerm](http://alliancegenome.org/ZFSTerm)
...
| ---  | ---  |
| self | ['alliance:ZFSTerm'] |
| native | ['alliance:ZFSTerm'] |
