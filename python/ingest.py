...
# Generation date: 2022-01-28T10:20:50
...
class Species(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/model/schema/ingest/Species")
...
class FBBTTerm(AnatomicalTerm):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/model/schema/ingest/FBBTTerm")
...
class NoteType(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/model/schema/ingest/NoteType")
