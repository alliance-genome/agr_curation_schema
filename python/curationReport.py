...
# Generation date: 2022-07-18T14:37:20
...
slots.xlsx_file_path = Slot(uri=ALLIANCE.xlsx_file_path, name="xlsx_file_path", curie=ALLIANCE.curie('xlsx_file_path'),
                   model_uri=ALLIANCE.xlsx_file_path, domain=None, range=Optional[str])
