...
# Generation date: 2022-12-05T15:05:11
...
class CurationReportGroup(AuditedObject):
    ...
    class_class_uri: ClassVar[URIRef] = ALLIANCE.CurationReportGroup
    class_class_curie: ClassVar[str] = "alliance:CurationReportGroup"
    class_name: ClassVar[str] = "CurationReportGroup"
    class_model_uri: ClassVar[URIRef] = ALLIANCE.CurationReportGroup
...
class CurationReport(AuditedObject):
    ...
    class_class_uri: ClassVar[URIRef] = ALLIANCE.CurationReport
    class_class_curie: ClassVar[str] = "alliance:CurationReport"
    class_name: ClassVar[str] = "CurationReport"
    class_model_uri: ClassVar[URIRef] = ALLIANCE.CurationReport
...
class CurationReportHistory(AuditedObject):
    ...
    class_class_uri: ClassVar[URIRef] = ALLIANCE.CurationReportHistory
    class_class_curie: ClassVar[str] = "alliance:CurationReportHistory"
    class_name: ClassVar[str] = "CurationReportHistory"
    class_model_uri: ClassVar[URIRef] = ALLIANCE.CurationReportHistory
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.xls_file_path is not None and not isinstance(self.xls_file_path, str):
            self.xls_file_path = str(self.xls_file_path)

        if self.html_file_path is not None and not isinstance(self.html_file_path, str):
            self.html_file_path = str(self.html_file_path)
...
slots.birt_report_file_path = Slot(uri=ALLIANCE.birt_report_file_path, name="birt_report_file_path", curie=ALLIANCE.curie('birt_report_file_path'),
                   model_uri=ALLIANCE.birt_report_file_path, domain=None, range=Optional[str])

slots.pdf_file_path = Slot(uri=ALLIANCE.pdf_file_path, name="pdf_file_path", curie=ALLIANCE.curie('pdf_file_path'),
                   model_uri=ALLIANCE.pdf_file_path, domain=None, range=Optional[str])

slots.xls_file_path = Slot(uri=ALLIANCE.xls_file_path, name="xls_file_path", curie=ALLIANCE.curie('xls_file_path'),
                   model_uri=ALLIANCE.xls_file_path, domain=None, range=Optional[str])

slots.html_file_path = Slot(uri=ALLIANCE.html_file_path, name="html_file_path", curie=ALLIANCE.curie('html_file_path'),
                   model_uri=ALLIANCE.html_file_path, domain=None, range=Optional[str])

slots.curation_report_group = Slot(uri=ALLIANCE.curation_report_group, name="curation_report_group", curie=ALLIANCE.curie('curation_report_group'),
                   model_uri=ALLIANCE.curation_report_group, domain=CurationReport, range=Optional[Union[dict, CurationReportGroup]])

slots.curation_report = Slot(uri=ALLIANCE.curation_report, name="curation_report", curie=ALLIANCE.curie('curation_report'),
                   model_uri=ALLIANCE.curation_report, domain=CurationReportHistory, range=Optional[Union[dict, CurationReport]])

slots.curation_report_status = Slot(uri=ALLIANCE.curation_report_status, name="curation_report_status", curie=ALLIANCE.curie('curation_report_status'),
                   model_uri=ALLIANCE.curation_report_status, domain=None, range=Optional[str])

slots.curation_report_timestamp = Slot(uri=ALLIANCE.curation_report_timestamp, name="curation_report_timestamp", curie=ALLIANCE.curie('curation_report_timestamp'),
                   model_uri=ALLIANCE.curation_report_timestamp, domain=CurationReportHistory, range=Optional[Union[str, XSDDate]])

slots.error_message = Slot(uri=ALLIANCE.error_message, name="error_message", curie=ALLIANCE.curie('error_message'),
                   model_uri=ALLIANCE.error_message, domain=CurationReport, range=Optional[str])
...
slots.scheduling_error_message = Slot(uri=ALLIANCE.scheduling_error_message, name="scheduling_error_message", curie=ALLIANCE.curie('scheduling_error_message'),
                   model_uri=ALLIANCE.scheduling_error_message, domain=CurationReport, range=Optional[str])
