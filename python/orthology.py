...
# Generation date: 2022-04-23T00:01:44
...
class AlleleVariantAssociation(AlleleGenomicEntityAssociation):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm/AlleleVariantAssociation")
...
class SequenceTargetingReagentToGeneAssociation(Association):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm/SequenceTargetingReagentToGeneAssociation")
...
class ConstructComponentAssociation(Association):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm/ConstructComponentAssociation")
...
class MeshDetail(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm/MeshDetail")
...
class XBEDTerm(OntologyTerm):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm/XBEDTerm")
...
class XBSTerm(StageTerm):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm/XBSTerm")
...
class XBATerm(AnatomicalTerm):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm/XBATerm")
...
class XPOTerm(PhenotypeTerm):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm/XPOTerm")
...
class XSMOTerm(ChemicalTerm):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm/XSMOTerm")
...
class SourceVariantLocation(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm/SourceVariantLocation")
