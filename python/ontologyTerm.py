...
# Generation date: 2022-05-09T12:57:11
...
class GenomicLocation(AuditedObject):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/ontologyTerm.yaml/GenomicLocation")
