...
# Generation date: 2022-03-04T08:19:00
...
slots.disease_qualifiers = Slot(uri=ALLIANCE.disease_qualifiers, name="disease_qualifiers", curie=ALLIANCE.curie('disease_qualifiers'),
                   model_uri=ALLIANCE.disease_qualifiers, domain=None, range=Optional[Union[Union[str, "DiseaseAnnotationQualifierEnum"], List[Union[str, "DiseaseAnnotationQualifierEnum"]]]])
