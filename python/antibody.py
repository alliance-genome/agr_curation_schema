...
# Generation date: 2022-02-09T15:18:09
...
class NoteType(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/src/schema/antibody.yaml/NoteType")
