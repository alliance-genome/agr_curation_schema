...
# Generation date: 2022-02-22T16:04:36
...
class Reagent(BiologicalEntity):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/src/schema/allele/Reagent")
...
slots.component_relation = Slot(uri=DEFAULT_.component_relation, name="component_relation", curie=DEFAULT_.curie('component_relation'),
                   model_uri=DEFAULT_.component_relation, domain=None, range=Optional[Union[str, "ComponentRelationsEnum"]])

slots.construct_components = Slot(uri=DEFAULT_.construct_components, name="construct_components", curie=DEFAULT_.curie('construct_components'),
...
slots.affected_entities = Slot(uri=DEFAULT_.affected_entities, name="affected_entities", curie=DEFAULT_.curie('affected_entities'),
...
slots.has_reference = Slot(uri=DEFAULT_.has_reference, name="has_reference", curie=DEFAULT_.curie('has_reference'),
...
slots.MolecularMutation_mutation_type = Slot(uri=DEFAULT_.mutation_type, name="MolecularMutation_mutation_type", curie=DEFAULT_.curie('mutation_type'),
...
slots.Figure_has_reference = Slot(uri=DEFAULT_.has_reference, name="Figure_has_reference", curie=DEFAULT_.curie('has_reference'),
