...
# Generation date: 2022-02-11T15:25:20
# Schema: image.yaml
#
...
class NoteType(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_persistent_schema/src/schema/image.yaml/NoteType")
