...
# Generation date: 2022-04-20T10:07:24
# Schema: image.yaml
#
...
slots.Variant_name = Slot(uri=ALLIANCE.name, name="Variant_name", curie=ALLIANCE.curie('name'),
                   model_uri=DEFAULT_.Variant_name, domain=Variant, range=str)
