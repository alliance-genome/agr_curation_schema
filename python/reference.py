...
# Generation date: 2022-02-07T20:22:15
# Schema: reference
#
...
class NoteType(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/src/schema/reference/NoteType")
