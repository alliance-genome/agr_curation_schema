...
# Generation date: 2022-12-05T15:05:14
...
class BulkLoadFile(AuditedObject):
    ...
    date_last_loaded: Optional[Union[str, XSDDate]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.date_last_loaded is not None and not isinstance(self.date_last_loaded, XSDDate):
            self.date_last_loaded = XSDDate(self.date_last_loaded)
...
slots.date_last_loaded = Slot(uri=ALLIANCE.date_last_loaded, name="date_last_loaded", curie=ALLIANCE.curie('date_last_loaded'),
                   model_uri=ALLIANCE.date_last_loaded, domain=BulkLoadFile, range=Optional[Union[str, XSDDate]])
...
slots.load_started = Slot(uri=ALLIANCE.load_started, name="load_started", curie=ALLIANCE.curie('load_started'),
                   model_uri=ALLIANCE.load_started, domain=None, range=Optional[Union[str, XSDDate]])

slots.load_finished = Slot(uri=ALLIANCE.load_finished, name="load_finished", curie=ALLIANCE.curie('load_finished'),
                   model_uri=ALLIANCE.load_finished, domain=None, range=Optional[Union[str, XSDDate]])
