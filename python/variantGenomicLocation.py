...
# Generation date: 2022-01-26T15:59:20
...
class Species(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/src/schema/variantGenomicLocation/Species")
...
class FBBTTerm(AnatomicalTerm):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_curation_schema/src/schema/variantGenomicLocation/FBBTTerm")
